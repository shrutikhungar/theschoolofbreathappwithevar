export const SWARA_COURSE = { id: '6', title: 'Swara Yoga Breath Alignment to Achieve Success in Life', description: '', image: require('../../assets/AllCourseSwaraYogaCourseImage.png'), type: 'Swara Yoga', days: '0.5 mil', time: 'Watch At your Own Pace' ,
author:{
    ...
    profileImage: require('../../assets/courses/Abhibg.png'), // replace with actual path to the profile image
  },
  reviews:[
    {
      id: '1',
